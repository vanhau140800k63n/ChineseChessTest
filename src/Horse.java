...
public class Horse extends Chess {
    ...
    public boolean[][] pointCanEat(Chess[][] chessCheck, int x, int y, Graphics2D g2d, int[] pointOfChessX, int[] pointOfChessY) {
        ...
        if (x + 2 <= 9 && y + 1 <= 10 && chessCheck[x + 2][y + 1] != null && chessCheck[x + 1][y] == null && chessCheck[x][y].getStatus().compareTo(chessCheck[x + 2][y + 1].getStatus()) != 0) {
            g2d.fillOval(pointOfChessX[x + 2] - 317, pointOfChessY[y + 1] - 32, 10, 10);
            canEat[x + 2][y + 1] = true;
        }
        if (x - 2 >= 1 && y + 1 <= 10 && chessCheck[x - 2][y + 1] != null && chessCheck[x - 1][y] == null && chessCheck[x][y].getStatus().compareTo(chessCheck[x - 2][y + 1].getStatus()) != 0) {
            g2d.fillOval(pointOfChessX[x - 2] - 317, pointOfChessY[y + 1] - 32, 10, 10);
            canEat[x - 2][y + 1] = true;
        }
        if (x + 2 <= 9 && y - 1 >= 1 && chessCheck[x + 2][y - 1] != null && chessCheck[x + 1][y] == null && chessCheck[x][y].getStatus().compareTo(chessCheck[x + 2][y - 1].getStatus()) != 0) {
            g2d.fillOval(pointOfChessX[x + 2] - 317, pointOfChessY[y - 1] - 32, 10, 10);
            canEat[x + 2][y - 1] = true;
        }
        if (x - 2 >= 1 && y - 1 >= 1 && chessCheck[x - 2][y - 1] != null && chessCheck[x - 1][y] == null && chessCheck[x][y].getStatus().compareTo(chessCheck[x - 2][y - 1].getStatus()) != 0) {
            g2d.fillOval(pointOfChessX[x - 2] - 317, pointOfChessY[y - 1] - 32, 10, 10);
            canEat[x - 2][y - 1] = true;
        }

        if (x + 1 <= 9 && y + 2 <= 10 && chessCheck[x + 1][y + 2] != null && chessCheck[x][y + 1] == null && chessCheck[x][y].getStatus().compareTo(chessCheck[x + 1][y + 2].getStatus()) != 0) {
            g2d.fillOval(pointOfChessX[x + 1] - 317, pointOfChessY[y + 2] - 32, 10, 10);
            canEat[x + 1][y + 2] = true;
        }
        if (x - 1 >= 1 && y + 2 <= 10 && chessCheck[x - 1][y + 2] != null && chessCheck[x][y + 1] == null && chessCheck[x][y].getStatus().compareTo(chessCheck[x - 1][y + 2].getStatus()) != 0) {
            g2d.fillOval(pointOfChessX[x - 1] - 317, pointOfChessY[y + 2] - 32, 10, 10);
            canEat[x - 1][y + 2] = true;
        }
        if (x + 1 <= 9 && y - 2 >= 1 && chessCheck[x + 1][y - 2] != null && chessCheck[x][y - 1] == null && chessCheck[x][y].getStatus().compareTo(chessCheck[x + 1][y - 2].getStatus()) != 0) {
            g2d.fillOval(pointOfChessX[x + 1] - 317, pointOfChessY[y - 2] - 32, 10, 10);
            canEat[x + 1][y - 2] = true;
        }
        if (x - 1 >= 1 && y - 2 >= 1 && chessCheck[x - 1][y - 2] != null && chessCheck[x][y - 1] == null && chessCheck[x][y].getStatus().compareTo(chessCheck[x - 1][y - 2].getStatus()) != 0) {
            g2d.fillOval(pointOfChessX[x - 1] - 317, pointOfChessY[y - 2] - 32, 10, 10);
            canEat[x - 1][y - 2] = true;
        }
        return canEat;
    ...
    public ArrayList<Chess[][]> botCanGo(Chess[][] chessCheck, int x, int y) {
        ...
        if (x + 1 <= 9 && y - 2 >= 1 && chessCheck[x + 1][y - 2] == null && chessCheck[x][y - 1] == null) {
            if(chessCheck[x][y] == null) System.out.println(1);
            Chess[][] chess = remake(chessCheck);
            chess[x + 1][y - 2] = chess[x][y];
            chess[x + 1][y - 2].setPoint(new PointOfChess(x + 1, y - 2));
            chess[x][y] = null;
